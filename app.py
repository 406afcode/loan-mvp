...
# --- CSS INJECTION TO MATCH WORDPRESS ---
st.markdown("""
    <style>
        /* 1. Background Color - Match your page background */
        .stApp {
            background-color: #ffffff;
        }

        /* 2. Remove the top colored bar and header padding */
        header[data-testid="stHeader"] {
            display: none;
        }
        .block-container {
            padding-top: 1rem; /* Reduce white space at top */
        }

        /* 3. Match Font Family (Change 'Lato' to your theme's font) */
        html, body, [class*="css"] {
            font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; 
        }

        /* 4. Button Styling - Match your WP Theme Buttons */
        .stButton>button {
            background-color: #0073aa; /* CHANGE THIS to your WordPress Button Color */
            color: white;
            border-radius: 4px;
            border: none;
            height: 3em;
...
def analyze_existing_note(note_text):
    ...
    2. DEFAULT RATE: Look for "Default Rate" or "Event of Default". Capture the full text.
